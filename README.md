...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffdc4cc4780)
	- stacking header:(1)::<address>(0x7ffdc4cc47a0)
	- stacking header:(2)::<address>(0x7ffdc4cc47c0)
	- stacking header:(3)::<address>(0x7ffdc4cc47e0)
	- stacking header:(4)::<address>(0x7ffdc4cc4800)
	- stacking header:(5)::<address>(0x7ffdc4cc4820)
	- stacking header:(6)::<address>(0x7ffdc4cc4840)
	- stacking header:(7)::<address>(0x7ffdc4cc4860)
	- stacking header:(8)::<address>(0x7ffdc4cc4880)
	- stacking header:(9)::<address>(0x7ffdc4cc48a0)
...
(RESULT) : "12","trivia_logic","model-ai is an artificial intelligence model that will categorize research and could respond in main articular fashion.";
...
+query :: (artificial)
(RESPONSE) : "12","trivia_logic","model-ai is an artificial intelligence model that will categorize research and could respond in main articular fashion.";
...
incremental size function : 1
(RESULT) : "13","trivia_logic","you are amazing.";
...
+query :: (amazing)
(RESPONSE) : "13","trivia_logic","you are amazing.";
...
incremental size function : 1
(RESULT) : "9","question_answers","amazing suggestion.";
...
+query :: (amazing?)
(RESPONSE) : "9","question_answers","amazing suggestion.";
...
-:: :logic: (compute x computation)::-
	/export_backlogs
	[ simple x computation: type:[char]: len:16 vowels:10 consonants:4 special:2 
~:: parameter request: export_backlogs(both).
 ]
...
export_backlog() : 
	...
	~:: exporting backlogs - <backlog_queries> & <backlog_answers> to: "ai/log/backlog_queries.txt" && to "ai/log/backlog_answers.txt"

	~:: exported <backlog_queries>.
	~:: exported <backlog_answers>.
...
~:: manipulating session: 3.
(e|o)? : (entity #)? : 
	~:: modifying entity #1.
	~:: added to list (1)

	* nr of manipulating sessions : 1
	* manipulating (entities) in # session : 3 
	* modifying entities # : 1

	* manipulated entities : e(1) 
...
- number of objects: 0
- total time simulation run (nano seconds): 7748 ns.
