...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffc1e590230)
	- stacking header:(1)::<address>(0x7ffc1e590250)
	- stacking header:(2)::<address>(0x7ffc1e590270)
	- stacking header:(3)::<address>(0x7ffc1e590290)
	- stacking header:(4)::<address>(0x7ffc1e5902b0)
	- stacking header:(5)::<address>(0x7ffc1e5902d0)
	- stacking header:(6)::<address>(0x7ffc1e5902f0)
	- stacking header:(7)::<address>(0x7ffc1e590310)
	- stacking header:(8)::<address>(0x7ffc1e590330)
	- stacking header:(9)::<address>(0x7ffc1e590350)
...
-:: :logic: (compute x computation)::-
	wrapping logic around this
	[ simple x computation: type:char len:26 vowels:18 consonants:8 special:0  ]
...
(debug) calling prepare_ints() (from) -> "wrapping logic around this".
...
- account: (1) --> (EUR. 14.27 EURO).

- account changed to account (2).
...
- account changed to account (600).
...
- account (600):
	subtracting: -/- 900.13 EURO.
	balance: (-/-100.01 EURO).

-/-100.01 EURO
- total accross accounts: (EUR -/-78.74)
...
~:: storing accounts information --> (accounts.txt).
	~:: writing accounts:
		...
	~:: closing file.
