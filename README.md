...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffcfe07e170)
	- stacking header:(1)::<address>(0x7ffcfe07e190)
	- stacking header:(2)::<address>(0x7ffcfe07e1b0)
	- stacking header:(3)::<address>(0x7ffcfe07e1d0)
	- stacking header:(4)::<address>(0x7ffcfe07e1f0)
	- stacking header:(5)::<address>(0x7ffcfe07e210)
	- stacking header:(6)::<address>(0x7ffcfe07e230)
	- stacking header:(7)::<address>(0x7ffcfe07e250)
	- stacking header:(8)::<address>(0x7ffcfe07e270)
	- stacking header:(9)::<address>(0x7ffcfe07e290)
...
-:: :logic: (compute x computation)::-
	complicated task
	[ simple x computation: type:char len:16 vowels:11 consonants:5 special:0  ]
...
+query :: (complicated task)

-- answer:
	

~:: transponder -> prep()
(debug) word :: complicated
(debug) word :: task

~:: (debug)::nrOfWords = 2.
~:: (debug)::counter = 2.

(debug) calling prepare_ints() (from) -> "complicated task".
~:: succesfully opened dictionary: "ai/data/files/20k.txt".

~:: (debug) number of matching occurences: (2).

~:: intvars int_occurences[] ::~
(debug) 0) complicated :: #7037
(debug) 1) task :: #2035
...
~:: meta queries ~:: reverse_meta_query_lookup("7037, 2035, ") ~:::~


- assigned: (7037): complicated :: complicated :: 7037
- assigned: (2035): pasta :: pasta :: 2035
