...
~:: transponder queries.
	...
	~:: transponder->init().
		~:: successfully opened: "ai/data/weights".
...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffc30270eb0)
	- stacking header:(1)::<address>(0x7ffc30270ed0)
	- stacking header:(2)::<address>(0x7ffc30270ef0)
	- stacking header:(3)::<address>(0x7ffc30270f10)
	- stacking header:(4)::<address>(0x7ffc30270f30)
	- stacking header:(5)::<address>(0x7ffc30270f50)
	- stacking header:(6)::<address>(0x7ffc30270f70)
	- stacking header:(7)::<address>(0x7ffc30270f90)
	- stacking header:(8)::<address>(0x7ffc30270fb0)
	- stacking header:(9)::<address>(0x7ffc30270fd0)
...
~Creating Chain:
~:: chainCreate().
	~:: reading 'chain id' from store.
	~:: id=[0]
	~:: writing 'chain id' to store.
...
1666213176
-2516424(seconds) since January 17, 2022 in the current timezone
