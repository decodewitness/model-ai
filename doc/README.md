...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffd180d8870)
	- stacking header:(1)::<address>(0x7ffd180d8890)
	- stacking header:(2)::<address>(0x7ffd180d88b0)
	- stacking header:(3)::<address>(0x7ffd180d88d0)
	- stacking header:(4)::<address>(0x7ffd180d88f0)
	- stacking header:(5)::<address>(0x7ffd180d8910)
	- stacking header:(6)::<address>(0x7ffd180d8930)
	- stacking header:(7)::<address>(0x7ffd180d8950)
	- stacking header:(8)::<address>(0x7ffd180d8970)
	- stacking header:(9)::<address>(0x7ffd180d8990)
...
-:: finished x computation.
	...
	~:: debug :: sorter().
		~:: sorter() :: search_index_code::[article] : [ artificial ].
artificial
...
~:: done.
	~:: querymatches search string: "artificial".
...
-:: finished x computation.
	...
	~:: debug :: sorter().
		~:: sorter() :: search_index_code::[article] : [ example ].
example
*string_next_logic() :: ssh: "example".
	- HMAC string :: *string_next_logic() ::  (example) is >> 


~:: searching indexes:
	search1 : example
	search2 : example
	line1 :  example of a random string to illustrate or describe a similar object.  + 2 
	line2 :      sometimes we need an example of an example to illustrate what it is that we are trying to point out by examplar references, comparing examples with the outcome to approve of a concept to illustrate the 1st example, exemplary, leading by example, an illustration.  [example.dat]
~:: resonate_index::match found on line: (2).
~:: done.
	~:: querymatches search string: "example".

-* example is:
 example of a random string to illustrate or describe a similar object.  + 2 

     sometimes we need an example of an example to illustrate what it is that we are trying to point out by examplar references, comparing examples with the outcome to approve of a concept to illustrate the 1st example, exemplary, leading by example, an illustration.  [example.dat]
...
-:: finished x computation.
	...
	~:: debug :: sorter().
		~:: sorter() :: search_index_code::[article] : [ calc ].
calc
*string_next_logic() :: ssh: "calc".
	- HMAC string :: *string_next_logic() ::  (calc) is >> 
...
~:: listing entities & objects:
	- entity(1) (x:0 y:0 z:0) {<empty label>} entity(2) (x:0 y:0 z:0) {<empty label>} entity(3) (x:0 y:0 z:0) {<empty label>} entity(4) (x:0 y:0 z:0) {<empty label>} entity(5) (x:0 y:0 z:0) {<empty label>} 
...
- number of objects: 6
- total time simulation run (nano seconds): 35356 ns.
...
-:: finished x computation.
	...
	~:: debug :: sorter().
		~:: sorter() :: search_index_code::[article] : [ + ].
+
...
-:: finished x computation.
(add): number1 number2 + # #: adds (7.46456e+06+8.36464e+06): 1.58292e+07
