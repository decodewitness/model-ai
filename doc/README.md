...
<<<<<<< HEAD
	...
	- stacking header:(3)::<address>(0x7ffc4ba0db70)
	- stacking header:(4)::<address>(0x7ffc4ba0db90)
	- stacking header:(5)::<address>(0x7ffc4ba0dbb0)
	- stacking header:(6)::<address>(0x7ffc4ba0dbd0)
	- stacking header:(7)::<address>(0x7ffc4ba0dbf0)
...
>>>>>>> 247d9b4d677f1c27412157eda0de84a554c41d2f
	...
	- stacking header:(3)::<address>(0x7ffcdaa32900)
	- stacking header:(4)::<address>(0x7ffcdaa32920)
	- stacking header:(5)::<address>(0x7ffcdaa32940)
	- stacking header:(6)::<address>(0x7ffcdaa32960)
...
new meta : 12,8,1,27,1567
new meta : 1429,12,2548
new meta : 235,12,1139,2,2548
new meta : 3198,8,39,305
new meta : 3198,6,12,1139,2,3391
new meta : 3198
new meta : 24,235,2,2548
new meta : 3198,235,2935
new meta : -1
new meta : 5320
=======
=======
...
-:: finished x computation.
*string_next_logic() :: ssh: "just like stringing magick".
	- HMAC string :: *string_next_logic() ::  (just like stringing magick) is >> 
~:: file_access()
(debug) file_access(level=0).
...
(debug) word :: just
(debug) word :: like
(debug) word :: stringing
(debug) word :: magick

~:: (debug)::nrOfWords = 4.
~:: (debug)::counter = 4.

(debug) calling prepare_ints() (from) -> "just like stringing magick".
...
~:: meta queries ~:: reverse_meta_query_lookup("109,96,-1,-2,") ~:::~

~:: reverse meta query lookup: 
	- just		 --> *(a+i) = 109 - *(a+i) - 1 = 108
	- like		 --> *(a+i) = 96 - *(a+i) - 1 = 95
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	just like stringing magic
	[ simple x computation: type:[char]: len:25 vowels:18 consonants:7 special:0 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "just like stringing magic".
	- HMAC string :: *string_next_logic() ::  (just like stringing magic) is >> 
~:: file_access()
(debug) file_access(level=0).
...
+query :: (just like stringing magic)
