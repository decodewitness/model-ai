...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffcffb59630)
	- stacking header:(1)::<address>(0x7ffcffb59650)
	- stacking header:(2)::<address>(0x7ffcffb59670)
	- stacking header:(3)::<address>(0x7ffcffb59690)
	- stacking header:(4)::<address>(0x7ffcffb596b0)
	- stacking header:(5)::<address>(0x7ffcffb596d0)
	- stacking header:(6)::<address>(0x7ffcffb596f0)
	- stacking header:(7)::<address>(0x7ffcffb59710)
	- stacking header:(8)::<address>(0x7ffcffb59730)
	- stacking header:(9)::<address>(0x7ffcffb59750)
...
-:: finished x computation.
*string_next_logic() :: ssh: "another line of text".
	- HMAC string :: *string_next_logic() ::  (another line of text) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: finished x computation.
*string_next_logic() :: ssh: "something else".
	- HMAC string :: *string_next_logic() ::  (something else) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	make the transponder active
	[ simple x computation: type:[char]: len:27 vowels:18 consonants:9 special:0 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "make the transponder active".
	- HMAC string :: *string_next_logic() ::  (make the transponder active) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	trying to run the full batch
	[ simple x computation: type:[char]: len:28 vowels:22 consonants:6 special:0 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "trying to run the full batch".
	- HMAC string :: *string_next_logic() ::  (trying to run the full batch) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	seems like this functions
	[ simple x computation: type:[char]: len:25 vowels:17 consonants:8 special:0 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "seems like this functions".
	- HMAC string :: *string_next_logic() ::  (seems like this functions) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	another three queries
	[ simple x computation: type:[char]: len:21 vowels:12 consonants:9 special:0 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "another three queries".
	- HMAC string :: *string_next_logic() ::  (another three queries) is >> 
~:: file_access()
(debug) file_access(level=0).
...
-:: testing sample ::-
-:: :logic: (compute x computation)::-
	seems like it doesn't get all the queries
	[ simple x computation: type:[char]: len:41 vowels:26 consonants:14 special:1 ]

[ -- you're asking my input -- ]

-:: finished x computation.
*string_next_logic() :: ssh: "seems like it doesn't get all the queries".
	- HMAC string :: *string_next_logic() ::  (seems like it doesn't get all the queries) is >> 
~:: file_access()
(debug) file_access(level=0).
