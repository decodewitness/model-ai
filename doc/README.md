...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7fff4cf7e470)
	- stacking header:(1)::<address>(0x7fff4cf7e490)
	- stacking header:(2)::<address>(0x7fff4cf7e4b0)
	- stacking header:(3)::<address>(0x7fff4cf7e4d0)
	- stacking header:(4)::<address>(0x7fff4cf7e4f0)
	- stacking header:(5)::<address>(0x7fff4cf7e510)
	- stacking header:(6)::<address>(0x7fff4cf7e530)
	- stacking header:(7)::<address>(0x7fff4cf7e550)
	- stacking header:(8)::<address>(0x7fff4cf7e570)
	- stacking header:(9)::<address>(0x7fff4cf7e590)
...
-:: :logic: (compute x computation)::-
	logic sequence
	[ simple x computation: type:char len:14 vowels:8 consonants:6 special:0  ]
