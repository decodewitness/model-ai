...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffd1a1d4340)
	- stacking header:(1)::<address>(0x7ffd1a1d4360)
	- stacking header:(2)::<address>(0x7ffd1a1d4380)
	- stacking header:(3)::<address>(0x7ffd1a1d43a0)
	- stacking header:(4)::<address>(0x7ffd1a1d43c0)
	- stacking header:(5)::<address>(0x7ffd1a1d43e0)
	- stacking header:(6)::<address>(0x7ffd1a1d4400)
	- stacking header:(7)::<address>(0x7ffd1a1d4420)
	- stacking header:(8)::<address>(0x7ffd1a1d4440)
	- stacking header:(9)::<address>(0x7ffd1a1d4460)
...
(curl engine function) (provide an URL) :: 
********* CURLING **********
...
<!DOCTYPE html>
<head>
<title>MODEL-AI&copy; |Artificial Intelligence</title>
<!-- Google Analytics -->
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-PTP949Z');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PTP949Z"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

<div class="whitebluebg paddedl">
  <h1 class="zeromargin">MODEL-AI&copy; |</h1>
  <h1>Artificial Intelligence Systems</h1>
  <h3 class="zeromargin">Artificial Intelligence Design</h3>
</div>

<div class="">
  <sub>website last updated: 02:15AM 18/02/2022 CET</sub>
</div>

<div class="bluebg white">
    Model-Ai&copy;
</div>
...
<div class="bluebg white pad margeb"></div>
<div>
  <p>Welcome to the <a class="hov" href="/"><strong>Model-Ai.com</strong></a> website, our main AI hub.</p>
  <p class="nomargbot"><strong>Shape Artificial Intelligence</strong></p>
</div>
<div class="">
  <a href="/downloads"><img class="marged rounder" src="images/Model-Ai.png" height="355" width="355" alt="MODEL-AI Logo" /></a>
</div>
<div class="margeb">
  <p class="nomargbot"><strong>Choose Our Ai For Building Your Solution</strong></p>
</div>
<div class="bluebg white pad margeb"></div>
<div class="padded1 margeb">
    <p>
      Over at <strong>Model-Ai&copy;</strong> we are trying to build an <strong>artificial intelligence</strong> which is tailored to your needs.
      </p>
    <p>
      ...
      So, we are still building the preliminary model to be fitted to our needs.
      </p>
    <p>
      You can <strong>register your e-mail address</strong> with <strong>Model-Ai.com</strong> under this heading on this page, if you want to be kept<br />
      up-to-date about the model's status, or if you would like to receive news regarding our model <strong>(Model-Ai&copy;)</strong>.
      </p>
</div>
<div class="bluebg white pad"></div>

<div class="bluebg white">
  <!-- Begin Mailchimp Signup Form -->
  <div id="mc_embed_signup">
    <form action="https://model-ai.us14.list-manage.com/subscribe/post?u=868ab24019f49cb67c9b6d0ad&amp;id=b186a43da8" method="post" class="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
      <label for="mce-EMAIL">Subscribe</label>
      <input type="email" value="" name="EMAIL" class="marged email" id="mce-EMAIL" placeholder="email address" required>
...
<footer>
  <p>
    <strong><a href="https://model-ai.com">Model-Ai&copy;</a></strong>
    <br />
    Copyright(&copy;)(2021);
    <br />
...
~:: parameter request: tableTo().
 ]
-:: finished x computation.
(table): of :# (to maximal): :# - table of: 777 to: 20
  -----
777 * 1 = 777
777 * 2 = 1554
777 * 3 = 2331
...
-:: :logic: (compute x computation)::-
	stat
	[ simple x computation: type:[char]: len:4 vowels:3 consonants:1 special:0 
~:: parameter request: stat_dir().
 ]
-:: finished x computation.
(stat): dir : 
~:: stats() function:
regular file: 
	--statdir("main.cpp") (flag:0)
...
-:: :logic: (compute x computation)::-
	cp
	[ simple x computation: type:[char]: len:2 vowels:2 consonants:0 special:0 
~:: parameter request: cp().
 ]
-:: finished x computation.
(cp): src dst: 
~:: 1 file copied. (functions.txt) (func2.txt)
...
-:: :logic: (compute x computation)::-
	rm
	[ simple x computation: type:[char]: len:2 vowels:2 consonants:0 special:0 
~:: parameter request: rm().
 ]
-:: finished x computation.
(rm): filename : 
~:: removed 1 file. (func2.txt)
...
-:: finished x computation.
(add): number1 number2 + # #: adds (8648+3848): 12496
...
- number of objects: 1
- total time simulation run (nano seconds): 33213 ns.
...
-:: :logic: (compute x computation)::-
	convert
	[ simple x computation: type:[char]: len:7 vowels:5 consonants:2 special:0 
~:: parameter request: converter EURO().
 ]
-:: finished x computation.

(converter) (EURO->USD) : 
~:: course converter: 
	*--> euro: 1011 = ($1294.08) dollar.
...
HMAC : string_next_logic() :: >> help is 
...
~:: searching indexes:
    deciphering algorithms.                                         + 1
LINE II:     IQ is smart RPIs in resource and key management in assigning data in research initiatives, using the fishing tool to fish out updates in information, intuition pumps, solving logic patiently, having more patience.   [intelligence.dat]

(debug): search_index_code(line2) :: search_index:article :: [intelligence.dat]
[intelligence.dat]
...
~:: searching indexes:
LINE II:           being artificial, artificial lives could exist that are even less sentient than human beings and might look artificial, higher artificial intelligence can possibly encompass our ways of extinction and seem to prevent our instinction in such an event.

(debug): search_index_code(line2) :: search_index:article :: 
...
~:: searching indexes:
           logic is my only type of relation inside this algorithm.        + 2
...
HMAC : string_next_logic() :: >> model-ai is 


~:: searching indexes:
        Model-Ai client
LINE II:     MODEL-Ai an artificial automata program with Artificial Intelligence which likes precision, Model-Ai.
