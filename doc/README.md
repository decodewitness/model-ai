...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffdc846a2c0)
	- stacking header:(1)::<address>(0x7ffdc846a2e0)
	- stacking header:(2)::<address>(0x7ffdc846a300)
	- stacking header:(3)::<address>(0x7ffdc846a320)
	- stacking header:(4)::<address>(0x7ffdc846a340)
	- stacking header:(5)::<address>(0x7ffdc846a360)
	- stacking header:(6)::<address>(0x7ffdc846a380)
	- stacking header:(7)::<address>(0x7ffdc846a3a0)
	- stacking header:(8)::<address>(0x7ffdc846a3c0)
	- stacking header:(9)::<address>(0x7ffdc846a3e0)
...
-:: :logic: (compute x computation)::-
	logical top influence
	[ simple x computation: type:char len:21 vowels:13 consonants:8 special:0  ]
...
(debug) word :: logical
(debug) word :: top
(debug) word :: influence

~:: (debug)::nrOfWords = 3.
~:: (debug)::counter = 3.

(debug) calling prepare_ints() (from) -> "logical top influence".
...
~:: meta queries ~:: reverse_meta_query_lookup("5753,103,2942,") ~:::~


A[I]:(5753)(0) 5753
+meta queries:
(debug) 0) logical :: logical
(debug) 1)  :: logical
(debug) 2)  :: logical
