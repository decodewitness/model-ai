...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffc84644820)
	- stacking header:(1)::<address>(0x7ffc84644840)
	- stacking header:(2)::<address>(0x7ffc84644860)
	- stacking header:(3)::<address>(0x7ffc84644880)
	- stacking header:(4)::<address>(0x7ffc846448a0)
	- stacking header:(5)::<address>(0x7ffc846448c0)
	- stacking header:(6)::<address>(0x7ffc846448e0)
	- stacking header:(7)::<address>(0x7ffc84644900)
	- stacking header:(8)::<address>(0x7ffc84644920)
	- stacking header:(9)::<address>(0x7ffc84644940)
...
~:: searching indexes:
LINE II:          [artificial.dat]   

(debug): search_index_code(line2) :: search_index:article :: [artificial.dat]   
[artificial.dat]   

LINE II:      sometimes we need an example of an example to illustrate what it is we are trying to point out by example references, comparing examples with the outcome to approve of a concept, exemplary, lead by example.
