...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffec768ea40)
	- stacking header:(1)::<address>(0x7ffec768ea60)
	- stacking header:(2)::<address>(0x7ffec768ea80)
	- stacking header:(3)::<address>(0x7ffec768eaa0)
	- stacking header:(4)::<address>(0x7ffec768eac0)
	- stacking header:(5)::<address>(0x7ffec768eae0)
	- stacking header:(6)::<address>(0x7ffec768eb00)
	- stacking header:(7)::<address>(0x7ffec768eb20)
	- stacking header:(8)::<address>(0x7ffec768eb40)
	- stacking header:(9)::<address>(0x7ffec768eb60)
...
-:: :logic: (compute x computation)::-
	in this type of responder is logic
	[ simple x computation: type:char len:34 vowels:24 consonants:10 special:0  ]
...
~:: sampler :: ~ :: generated (16)  new tracks-in-track.
	~:: total initialized tracks [65544].
...
+query :: (in this type of responder is logic)
...
(debug) calling prepare_ints() (from) -> "in this type of responder is logic".
...
~:: meta queries ~:: reverse_meta_query_lookup("6,12,235,2,-1,8,3198,") ~:::~
