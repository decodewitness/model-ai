...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffd9082c660)
	- stacking header:(1)::<address>(0x7ffd9082c680)
	- stacking header:(2)::<address>(0x7ffd9082c6a0)
	- stacking header:(3)::<address>(0x7ffd9082c6c0)
	- stacking header:(4)::<address>(0x7ffd9082c6e0)
	- stacking header:(5)::<address>(0x7ffd9082c700)
	- stacking header:(6)::<address>(0x7ffd9082c720)
	- stacking header:(7)::<address>(0x7ffd9082c740)
	- stacking header:(8)::<address>(0x7ffd9082c760)
	- stacking header:(9)::<address>(0x7ffd9082c780)
...
-:: :logic: (compute x computation)::-
	logic no compute
	[ simple x computation: type:char len:16 vowels:10 consonants:6 special:0  ]
...
(debug) calling prepare_ints() (from) -> "logic no compute".
