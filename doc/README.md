...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffef8dde000)
	- stacking header:(1)::<address>(0x7ffef8dde020)
	- stacking header:(2)::<address>(0x7ffef8dde040)
	- stacking header:(3)::<address>(0x7ffef8dde060)
	- stacking header:(4)::<address>(0x7ffef8dde080)
	- stacking header:(5)::<address>(0x7ffef8dde0a0)
	- stacking header:(6)::<address>(0x7ffef8dde0c0)
	- stacking header:(7)::<address>(0x7ffef8dde0e0)
	- stacking header:(8)::<address>(0x7ffef8dde100)
	- stacking header:(9)::<address>(0x7ffef8dde120)
...
~:: listing entities & objects:
	- entity(1) (x:0 y:0 z:0) {<empty label>} entity(2) (x:0 y:0 z:0) {<empty label>} entity(3) (x:0 y:0 z:0) {<empty label>} entity(4) (x:0 y:0 z:0) {<empty label>} entity(5) (x:0 y:0 z:0) {<empty label>} entity(6) (x:0 y:0 z:0) {<empty label>} 
	- obj(1) (x:0 y:0 z:0) {<empty object>}obj(2) (x:0 y:0 z:0) {<empty object>}obj(3) (x:0 y:0 z:0) {<empty object>}obj(4) (x:0 y:0 z:0) {<empty object>}obj(5) (x:0 y:0 z:0) {<empty object>}obj(6) (x:0 y:0 z:0) {<empty object>}
...
~:: manipulate session #: 	~:: number of entities to modify in session #: 	~:: number of objects to modify in session #: 
~:: manipulate on entity (end with a negative number e.g. '-9') :: (entity_number_1, entity_number_n, ...) #: 
:: :: :: 
~:: manipulate on object (end with a negative number e.g. '-9') :: (object_number_1, object_number_n, ...) #: 
	:: 	:: 
~:: manipulating sessions: 2
	* modifying entities : 3
	* modifying objects   : 2


	~:: sim::entering cycle -1-.
	~:: sim::entering cycle -2-.
		~:: manipulating on {Entities} (1).
		~:: manipulating on {Objects} (1).
...
- number of objects: 6
- total time simulation run (nano seconds): 169295 ns.
...
-:: :logic: (compute x computation)::-
	...
	[ simple x computation: type:[char]: len:0 vowels:0 consonants:0 special:0  ]
-:: finished x computation.
