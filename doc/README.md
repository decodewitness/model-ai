...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7fff9cec7080)
	- stacking header:(1)::<address>(0x7fff9cec70a0)
	- stacking header:(2)::<address>(0x7fff9cec70c0)
	- stacking header:(3)::<address>(0x7fff9cec70e0)
	- stacking header:(4)::<address>(0x7fff9cec7100)
	- stacking header:(5)::<address>(0x7fff9cec7120)
	- stacking header:(6)::<address>(0x7fff9cec7140)
	- stacking header:(7)::<address>(0x7fff9cec7160)
	- stacking header:(8)::<address>(0x7fff9cec7180)
	- stacking header:(9)::<address>(0x7fff9cec71a0)
...
~:: searching indexes.
	:: hit(2)           logic is my only type of relation inside this algorithm.        + 2
...
HMAC : string_next_logic() :: logic :-L|| artificial          being artificial, artificial lives could exist that are even less sentient than human beings and might look artificial, higher artificial intelligence can possibly encompass our ways of extinction and seem to prevent our instinction in such an event., 
...
~:: searching indexes.
	:: hit(1)    deciphering algorithms.                                         + 1
 hit(2)    deciphering algorithms.                                         + 1
...
HMAC : string_next_logic() :: intelligence :-L|| artificial          being artificial, artificial lives could exist that are even less sentient than human beings and might look artificial, higher artificial intelligence can possibly encompass our ways of extinction and seem to prevent our instinction in such an event., 
