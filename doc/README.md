...
~:: Status::count_definitions() :
	~:: counting number of definitions inside catalogue/references.
...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7fffe11ea5f0)
	- stacking header:(1)::<address>(0x7fffe11ea610)
	- stacking header:(2)::<address>(0x7fffe11ea630)
	- stacking header:(3)::<address>(0x7fffe11ea650)
	- stacking header:(4)::<address>(0x7fffe11ea670)
	- stacking header:(5)::<address>(0x7fffe11ea690)
	- stacking header:(6)::<address>(0x7fffe11ea6b0)
	- stacking header:(7)::<address>(0x7fffe11ea6d0)
	- stacking header:(8)::<address>(0x7fffe11ea6f0)
	- stacking header:(9)::<address>(0x7fffe11ea710)
