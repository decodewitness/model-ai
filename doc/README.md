...
~:: stacking headers/modules ::~
	- stacking header:(0)::<address>(0x7ffd7dacc020)
	- stacking header:(1)::<address>(0x7ffd7dacc040)
	- stacking header:(2)::<address>(0x7ffd7dacc060)
	- stacking header:(3)::<address>(0x7ffd7dacc080)
	- stacking header:(4)::<address>(0x7ffd7dacc0a0)
	- stacking header:(5)::<address>(0x7ffd7dacc0c0)
	- stacking header:(6)::<address>(0x7ffd7dacc0e0)
	- stacking header:(7)::<address>(0x7ffd7dacc100)
	- stacking header:(8)::<address>(0x7ffd7dacc120)
	- stacking header:(9)::<address>(0x7ffd7dacc140)
...
-:: :logic: (compute x computation)::-
	transform into logic sequence
	[ simple x computation: type:[char]: len:29 vowels:19 consonants:10 special:0  ]
